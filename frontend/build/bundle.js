...
function makeRequest(posted_url) {
  var request = new Request('http://localhost:3000/api/new', {
    method: 'POST',
    headers: {
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function onSubmit(event) {
      ...
      makeRequest(this.state.text).then(function (data) {
        // console.log(data);
        _this2.setState({
          isLoading: false,
          data: data
    ...
    value: function navigate(event) {
      var url = this.state.data.original_url;
      var re = /^(https?:\/\/)?([^\/]+\.[^\.\/]+)(\/.+)?/;
      var href = url.match(re)[1] ? url : 'http://' + url;
      location.href = href;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { id: 'url' },
            !this.state.isLoading && 'Original url: ' + this.state.data.original_url
          ),
          _react2.default.createElement(
            'div',
            { id: 'shorturl' },
            ...
            !this.state.isLoading && _react2.default.createElement(
              'a',
              { href: !this.state.isLoading && href, onClick: this.navigate },
